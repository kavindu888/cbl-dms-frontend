...
function applyStoredTheme(): 'dark' | 'light' {
  try {
    ...
    const parsed = JSON.parse(raw) as {
      ...
      fontSans?: string
      fontMono?: string
      borderRadius?: 'compact' | 'default' | 'rounded'
    }
    ...
    root.style.setProperty('--radius-button', radius === 'compact' ? '4px' : radius === 'rounded' ? '10px' : '6px')
  } catch {
