      ...
      <Dialog.Portal>
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} onKeyDown={handleFormKeyDown} style={{ padding: '0 32px 32px 32px', display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            {/* Code Row */}
            <div>
              <label style={{ display: 'block', fontSize: 11, fontWeight: 600, letterSpacing: '0.8px', color: 'var(--color-text-muted)', marginBottom: 8, textTransform: 'uppercase' }}>BRAND CODE</label>
              <input
                {...register('code')}
                autoFocus
            ...
            {/* Name Row */}
            <div>
              <label style={{ display: 'block', fontSize: 11, fontWeight: 600, letterSpacing: '0.8px', color: 'var(--color-text-muted)', marginBottom: 8, textTransform: 'uppercase' }}>BRAND NAME</label>
              <input
                {...register('name')}
                className="form-input w-full"
            ...
            <div>
              <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                ...
                />
                <span style={{ fontSize: 14, color: 'var(--color-text-primary)' }}>Active Brand</span>
              </label>
            </div>
              ...
              <tbody>
                {filtered.map((b) => (
                  <tr key={b.id}>
                    ...
                    <td className="mono text-xs" style={{ color: 'var(--color-text-muted)' }}>{b.productCount}</td>
                    <td>
