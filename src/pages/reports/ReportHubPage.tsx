          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <span
                ...
                style={{ background: 'var(--color-bg-elevated)', color: 'var(--color-text-dim)', border: '1px solid var(--color-border)' }}
              >
                {r.tag}
              </span>
            </div>
            <p className="font-semibold text-base" style={{ color: 'var(--color-text-primary)' }}>{r.title}</p>
            <p className="mt-2 text-sm leading-relaxed" style={{ color: 'var(--color-text-muted)' }}>{r.description}</p>
            <p
