export const PERMISSIONS = {
  ...
  sales: {
    ...
    invoiceAdminEditLines: 'sales:invoice:admineditlines',
  ...
  collections: {
    ...
    chequeRead: 'collections:cheque:read',
    chequeManage: 'collections:cheque:manage',
    depositBatchCreate: 'collections:depositbatch:create',
    depositBatchManage: 'collections:depositbatch:manage',
